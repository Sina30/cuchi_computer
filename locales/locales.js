const Locales = {
    ...
    DE: {
        ...
        os_shuttingdown: "Herunterfahren...",
        os_shutdown_confirmation: "Sie sind dabei, den Computer herunterzufahren. Sind Sie sicher?",
        os_shutdown_forced: "Erzwungenes Herunterfahren (zu weit von offener Position entfernt)...",
        os_error: "Fehler",
        ...
        cmd_help_desc: "Zeigt alle verfügbaren Befehle an.",
        cmd_version_desc: "Zeigt die aktuelle Version an.",
        cmd_clear_desc: "Löscht die Konsolenausgabe.",
        cmd_exit_desc: "Beendet die Eingabeaufforderung.",
        cmd_shutdown_desc: "Computer herunterfahren.",
        cmd_start_desc: "Starten Sie eine Anwendung.<br>    Verwendung: start [app]",
        ...
        cmd_taskkill_desc: "Beenden Sie eine Anwendung.<br>    Verwendung: taskkill [app]",
        ...
        cmd_iptracer_desc: "Informationen zu einer angegebenen IP-Adresse abrufen.<br>    Verwendung: ip-tracer [IPv4]",
        cmd_iptracer_not_specified: "Sie müssen eine IP-Adresse angeben.<br>    Verwendung: ip-tracer [IPv4]",
        cmd_iptracer_error: "Die IP-Adresse ist inkorrekt. Sie sollte so aussehen: 11.22.33.44.",
        ...
        cmd_iptracer_disconnected: "Die IP-Adresse {1} ist <span style='color:red'>nicht mit dem Netzwerk verbunden</span>.",
        ...
        cmd_connect_success: "Erfolgreich mit <span style='color:green'>{1}</span> verbunden.",
        cmd_detect_desc: "IP des Netzwerks von Ihrem aktuellen Standort erkennen.<br>    Normaler Gebrauch: detect -ip",
        cmd_detect_arg: "Sie müssen den Erfassungstyp angeben.<br>    Normaler Gebrauch: detect -ip",
        ...
        cmd_scan_desc: "Dinge auf der angegebenen IP-Adresse scannen.<br>    Normaler Gebrauch: scan -ports [ip]",
        cmd_scan_arg: "Sie müssen angeben, was Sie scannen möchten.<br>    Normaler Gebrauch: scan -ports [ip]",
        ...
        cmd_infiltrate_desc: "Finden und infiltrieren Sie einen Dienst auf einem bestimmten Port und einer Adresse.<br>    Normaler Gebrauch: infiltrate -ip [ip] -port [open-port]",
        cmd_infiltrate_arg: "Sie müssen die IP und den Port angeben.<br>    Normaler Gebrauch: infiltrate -ip [ip] -port [open-port]",
        cmd_infiltrate_wrong: "Es konnte kein Dienst gefunden werden, um {1}:{2} zu infiltrieren",
        cmd_infiltrate_good: "Dienst auf {1}:{2} <span style='color:green'>infiltriert</span>.",
        cmd_breach_desc: "Daten des infiltrierten Dienstes durchbrechen.<br>    Normaler Gebrauch: breach -ip [ip] -port [open-port]",
        cmd_breach_arg: "Sie müssen die IP und den Port angeben.<br>    Normaler Gebrauch: breach -ip [ip] -port [open-port]",
        cmd_breach_bad: "Es konnte kein Dienst gefunden werden, um {1}:{2} zu durchbrechen",
        cmd_breach_no: "Sie müssen den Dienst infiltrieren, bevor Sie ihn durchbrechen können.",
        cmd_breach_good: "Dienst wurde durchbrochen, Daten werden geschrieben nach:<br><span style='color:crimson'>{1}</span>",
        cmd_breach_delay: "Sie müssen warten, bevor Sie diesen Dienst durchbrechen können.",
        ...
        error_market_id_not_yours: "Diese ID gehört nicht zu Ihren Beiträgen.",
        ...
        market_description: "Sie können alle {1} Sekunden einen Beitrag erstellen, Sie können maximal {2} Beiträge erstellen. Jeder Beitrag bleibt {3} Tage aktiv.",
        ...
        mail_passwords_different: "Passwörter sind unterschiedlich.",
        ...
        mail_password_empty: "Setzen Sie ein Passwort.",
        mail_password_warning: "⚠️ WARNUNG: Geben Sie kein echtes Passwort ein!",
        mail_connect_wrong: "Das Konto existiert nicht oder der Benutzername oder das Passwort ist inkorrekt.",
        ...
        addresses_desc: "Benutzer sollten beim Besuch der aufgeführten Domains vorsichtig sein, und wir haften nicht für etwaige Folgen.",
